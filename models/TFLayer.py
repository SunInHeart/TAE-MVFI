...
class TFLayer(nn.Module):
    ...
    def forward(self, x):
        ...
        if not self.use_crossattn:
            ...
            if self.shift_size == 0:
                attn_windows = self.attn(x_windows, x_windows_down, mask_x=None, mask_y=None)  # nW*B, window_size*window_size, C
            else:
        ...
        # remove pad from feature maps, restore original size
